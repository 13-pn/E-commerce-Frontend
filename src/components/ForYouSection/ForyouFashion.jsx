      ...
      const [Loading, setLoading] = useState(true)
        useEffect(() => {
          const fetchprod=async()=>{
            try{
            let res=await fetch("https://fakestoreapi.com/products/category/women's%20clothing?limit=5")
  ...
  return (
   <div className='foryou-container  pt-4'>
       ...
       {Loading ? (
         ...
         <div className='boxes d-flex justify-content-md-between justify-content-center gap-3 gap-md-5 pt-4'>
...
export default ForyouSpecialPack